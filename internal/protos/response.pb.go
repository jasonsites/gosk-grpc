...
func (x *DomainResponse) GetStatus() uint32 {
	if x != nil {
		return x.Status
	}
	return 0
...
var file_response_proto_rawDesc = []byte{
	...
	0x12, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x22, 0x28, 0x0a, 0x0e, 0x44, 0x6f, 0x6d, 0x61,
	...
	0x75, 0x73, 0x42, 0x09, 0x5a, 0x07, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x62, 0x06, 0x70,
...
var file_response_proto_goTypes = []interface{}{
	(*DomainResponse)(nil), // 0: domain.DomainResponse
}
